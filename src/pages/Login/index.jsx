            ...
            <div className="my-0 mx-auto max-w-[1344px]">
                <div className="ml-[33%] w-[33%] text-[#7a7a7a]">
                    ...
                    <div className="p-[1.25rem] bg-[#363636] rounded mb-6">
                        <form action="" >
                            <input value={email} onChange={(e)=> {setEmail(e.target.value)}} className="input focus:input_focus" type="email" name="txt-email" id=""  placeholder="Email"/>
                            <input value={password} onChange={(e)=> {setPassword(e.target.value)}} className="input focus:input_focus" type="password" name="txt-password" id="" placeholder="Mật khẩu"/>
                            <input className="mb-3" type="checkbox" name="checkbox" id="" /> <span className="mb-3" >Ghi nhớ</span>
                            <button onClick={handleLogin} className="block w-full bg-[#3E8ED0] text-white px-[24px] h-[60px] text-2xl rounded hover:bg-[#3488ce]" type="submit">Đăng nhập</button>
